...
const services_1 = require("../services"); //llamar el servicio
...
let UsuarioController = class UsuarioController {
    ...
    async create(usuario) {
        ...
        let destino = usuario.telefono; //para enviar por email usuario.correo
...
(0, tslib_1.__decorate)([
    authentication_1.authenticate.skip() //autentica el post acceso para el token
    ,
...
(0, tslib_1.__decorate)([
    authentication_1.authenticate.skip() //autentica el acceso post para el token
    ,
    (0, rest_1.post)('/login', {
        responses: {
            '200': {
    ...
    (0, tslib_1.__param)(0, (0, rest_1.requestBody)()),
    (0, tslib_1.__metadata)("design:type", Function),
    (0, tslib_1.__metadata)("design:paramtypes", [models_2.Credenciales]),
    (0, tslib_1.__metadata)("design:returntype", Promise)
], UsuarioController.prototype, "login", null);
UsuarioController = (0, tslib_1.__decorate)([
    (0, authentication_1.authenticate)("admin") //permite el acceso para el token los demas estan protegidos
    ,
